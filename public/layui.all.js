  ...
  (r.prototype.cache = n),
    ...
    (r.prototype.use = function (e, r, l) {
      function c(e, t) {
        ...
        ('load' === e.type || r.test((e.currentTarget || e.srcElement).readyState)) &&
          ((n.modules[d] = t),
          y.removeChild(h),
          (function o() {
      ...
      if (
        ...
        !(function g() {
          return ++m > (1e3 * n.timeout) / 4
            ? a(d + ' is not a valid module')
            : void ('string' == typeof n.modules[d] && n.status[d] ? s() : setTimeout(g, 4));
        })();
      else {
        ...
        (h.async = !0),
          ...
          y.appendChild(h),
          !h.attachEvent ||
          (h.attachEvent.toString && h.attachEvent.toString().indexOf('[native code') < 0) ||
          i
            ? h.addEventListener(
                'load',
                function (e) {
        ...
        'function' != typeof r
          ...
          : ((function f() {
              return ++p > (1e3 * n.timeout) / 100
                ? a(e + ' timeout')
                : void (1989 === parseInt(i.getStyle(t.getElementById(s), 'width'))
                    ? (function () {
                        r();
                      })()
                    : setTimeout(f, 100));
      ...
      function (e, t, r, o) {
        ...
        return o
          ...
          : (layui.each(n.event[l], function (e, t) {
              return '{*}' === c
                ? void layui.each(t, s)
                : ('' === e && layui.each(t, s), void (c && e === c && layui.each(t, s)));
            }),
            i);
      }),
    (e.layui = new r());
  ...
  (F.prototype.config = {
    ...
    (F.prototype.render = function () {
      ...
      a.height &&
        ...
        ((e.fullHeightGap = a.height.split('-')[1]), (a.height = H.height() - e.fullHeightGap)),
        e.setInit();
      var l = a.elem,
        n = l.next('.' + v),
            ...
            c = [
              '<td data-field="' +
                ...
                (function () {
                  var e = [];
                  return (
                    o.hide && e.push(f), o.field || e.push('layui-table-col-special'), e.join(' ')
                  );
                })() +
                '">',
              '<div class="layui-table-cell laytable-cell-' +
    ...
    (F.prototype.fullSize = function () {
      var e,
        ...
        a = i.height;
      t.fullHeightGap &&
        ((a = H.height() - t.fullHeightGap), a < 135 && (a = 135), t.elem.css('height', a)),
        a &&
      ...
      i.layTool.on('click', '*[lay-event]', function (e) {
        ...
        switch ((layui.stope(e), j.trigger('table.tool.panel.remove'), l.close(i.tipsIndex), c)) {
          ...
          case 'LAYTABLE_EXPORT':
            r.ie
              ? l.tips(
                  'Chức năng xuất không hỗ trợ IE, vui lòng sử dụng trình duyệt nâng cao như Chrome để xuất',
                  this,
                  { tips: 3 }
                )
              : s({
                  list: (function () {
                    return [
                      '<li data-type="csv">Xuất ra file CSV</li>',
                      '<li data-type="xls">Xuất ra file Excel</li>',
                    ].join('');
                  })(),
                  done: function (e, l) {
                    l.on('click', function () {
